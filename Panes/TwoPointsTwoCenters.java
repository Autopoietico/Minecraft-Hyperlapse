...
public class TwoPointsTwoCenters extends javax.swing.JPanel {

    public TwoPointsTwoCenters() {
        initComponents();
    }
    ...
    private void jBut_GenerateComandsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBut_GenerateComandsActionPerformed
        ...
        double x1, y1, z1, x2, y2, z2, xC1, yC1, zC1, xC2, yC2, zC2;
        String nick;
        ...
        try {
            ...
            if (ticks == 0) {
                ...
                dAH = Calc.convertRadiansToDegrees(Calc.getHorizontalAngle2Points2Centers(x1, z1, x2, z2, xC1, zC1, xC2, zC2)) / ticks;
                dAV = Calc.convertRadiansToDegrees(Calc.getVerticalAngle2Points2Centers(x1, y1, z1, x2, y2, z2, xC1, yC1, zC1, xC1, yC2, zC2)) / ticks;

                this.jTxtField_InitialCommand.setText("/tp " + nick + " " + x1 + " " + y1 + " " + z1 + " " + iAH + " " + iAV);
                this.jTxtField_ComandCommandBlock.setText("tp " + nick + " ~" + dx + " ~" + dy + " ~" + dz + " ~" + dAH + " ~" + dAV);
            }
